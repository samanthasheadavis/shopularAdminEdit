# Shopular Admin Editing
#### Week 7 Day 2

For this project I updated Shopular functionality so that the user can add new items and order items in alphabetical or numeric order.

[See it on GitHub Pages](https://samanthasheadavis.github.io/shopularAdminEdit/)
#### Languages/Tools
* AngularJS
* JavaScript
* HTML5
